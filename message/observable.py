...
from .message import Broker  # noqa
...
def observable(cls):
    ...
    def __init__(self, *a, **kw):
        ...
        t(self, *a, **kw)
        # cls.__init__(self, *a, **kw)  # 小心陷入无限循环，因为cls.__init__已经被改写
        assert id(b) == id(
            self._message_broker), "_message_broker is a reserved word for observable, don't use it any where."
    ...
    for k, v in dict(
            ...
            has_declaration=has_declaration).items():
