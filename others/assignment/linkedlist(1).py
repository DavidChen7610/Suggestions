...
def switch(list, index):
    ...
    #Add your code here.
    switchnode = {}
    switchnode["data"] = None
    switchnode['next'] = None
    if switchnode != None:
        switchnode['data'] = switchlist['data']
        switchnode['next'] = switchnode
        ...
        list = switchlist
    return list
    #set the next pointer of this new node to the head of the list, linkedList newnode is now the head of the list
